...
@WebServlet(urlPatterns = "/QueryBookById")
public class QueryBookById extends HttpServlet {
    static final String JDBC_DRIVER = "com.mysql.cj.jdbc.Driver";
    static final String DB_URL = "jdbc:mysql://123.60.47.94/linux_final";
    static final String USER = "root";
    static final String PASS = "09010914Chen@";
    static final String SQL_QUERY_BOOK_ID = "SELECT id, name, author FROM t_book WHERE id=?";
      ...
      static Connection conn = null;
	   ...
	   public void init() {
	    ...
	    public Book getBook(int id) {
	        ...
	        try {
	            stmt = conn.prepareStatement(SQL_QUERY_BOOK_ID);
	            stmt.setInt(1, id);
